#!/bin/bash
#ffmpeg -f pulse -ac 2 -i default -f x11grab -r 30 -s 1680x1050 -i :0.0+0,0 -vcodec libx264 -threads 0 -y $1
#ffmpeg -f pulse -ac 2 -i default -r 30 -s 1680x1050 -f x11grab -i :0.0 -vcodec msmpeg4v2 -qscale 1 $1
...
#ffmpeg -f alsa -ac 2 -i pulse -acodec mp3 -f x11grab -r 30 -s 1680x1050 -i :0.0 -vcodec msmpeg4v2 -qscale 1 $1
#ffmpeg -video_size 1680x1050 -framerate 25 -f x11grab -i :0.0 -f pulse -ac 2 -i default $1
ffmpeg -video_size 1680x1050 -framerate 25 -f x11grab -i :0.0 -f pulse -vcodec mpeg2video  -thread_queue_size 512 -ac 2 -t 02:00:00 -i default $1